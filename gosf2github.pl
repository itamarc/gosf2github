 ...
 * all issues and comments will appear to have originated from the user who
   issues the OAuth ticket
 * confirm your rate limit for "core" before you start to ensure you have
   sufficient requests remaining to import your number of tickets. The
   script makes no effort to do this for you.
